...
ActiveRecord::Schema[7.1].define(version: 2026_05_15_230000) do
  ...
  create_table "ai_agent_conversation_states", force: :cascade do |t|
    ...
    t.index ["conversation_id", "ai_agent_id"], name: "index_ai_agent_conv_states_on_conv_and_agent", unique: true
  end

  create_table "ai_agent_logs", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.bigint "conversation_id", null: false
    t.bigint "ai_agent_id", null: false
    t.string "action"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "created_at"], name: "index_ai_agent_logs_on_account_id_and_created_at"
    t.index ["conversation_id"], name: "index_ai_agent_logs_on_conversation_id"
  end

  create_table "ai_agent_report_configs", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.bigint "inbox_id"
    t.string "frequency", default: "daily", null: false
    t.integer "send_hour", default: 8, null: false
    t.integer "send_day_of_week"
    t.integer "send_day_of_month"
    t.string "whatsapp_number"
    t.text "custom_prompt"
    t.boolean "include_conversation_count", default: true, null: false
    t.boolean "include_agent_stats", default: true, null: false
    t.boolean "include_handoff_rate", default: true, null: false
    t.boolean "include_tool_usage", default: false, null: false
    t.boolean "enabled", default: true, null: false
    t.datetime "last_sent_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_ai_agent_report_configs_on_account_id"
  end
  ...
  create_table "ai_agent_tools", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_ai_agent_tools_on_account_id"
  ...
  create_table "ai_agents", force: :cascade do |t|
    ...
    t.integer "context_window_messages", default: 50, null: false
  ...
  create_table "crm_stages", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.boolean "show_value_sum", default: false, null: false
  ...
  create_table "deal_conversations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["conversation_id"], name: "index_deal_conversations_on_conversation_id", unique: true
    t.index ["crm_deal_id"], name: "index_deal_conversations_on_crm_deal_id"
  end
  ...
  create_table "inbox_ai_agents", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.bigint "inbox_id", null: false
    t.bigint "ai_agent_id", null: false
    t.boolean "enabled", default: true, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_inbox_ai_agents_on_account_id"
    t.index ["inbox_id", "ai_agent_id"], name: "index_inbox_ai_agents_on_inbox_id_and_ai_agent_id", unique: true
  end
  ...
  create_table "inboxes", id: :serial, force: :cascade do |t|
    ...
    t.boolean "enable_crm", default: false
    t.bigint "default_crm_pipeline_id"
    t.index ["account_id"], name: "index_inboxes_on_account_id"
    t.index ["channel_id", "channel_type"], name: "index_inboxes_on_channel_id_and_channel_type"
    t.index ["default_crm_pipeline_id"], name: "index_inboxes_on_default_crm_pipeline_id"
  ...
  add_foreign_key "ai_agent_report_configs", "inboxes"
  ...
  add_foreign_key "deal_conversations", "crm_deals"
